 ...
 */
const getAllNames = arr => arr.map(curr => curr.name);
console.log("=================1================");
...
const getUsersByEyeColor = (arr, color) =>
  arr.filter(curr => curr.eyeColor === color);
console.log("=================2================");
...
const getUsersByGender = (arr, gender) =>
  arr.filter(curr => curr.gender === gender);
console.log("=================3================");
 ...
 */
const getInactiveUsers = arr => arr.filter(curr => !curr.isActive);
 ...
 */
const getUserByEmail = (arr, email) => arr.find(curr => curr.email === email);
...
const getUsersWithAge = (arr, min, max) =>
  arr.filter(curr => curr.age > min && curr.age < max);
 ...
 */
const getTotalBalance = arr => arr.reduce((acc, curr) => acc + curr.balance, 0);
console.log("=================7================");
...
const getUsersByFriend = (arr, name) =>
  arr.filter(curr => curr.friends.includes(name))
  .map(curr => curr.name);
console.log("=================8================");
